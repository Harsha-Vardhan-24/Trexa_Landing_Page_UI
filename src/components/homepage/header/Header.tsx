...
export const Header = ({ setToggleForm }: HeaderProps) => {
  const MENU_ITEMS = [
  ...
  return (
    <section>
      <header
        className={`backdrop-blur-sm bg-white/30 p-2 border border-1 border-solid border-slate-200 rounded-lg`}
      >
        <NavigationMenu>
          <NavigationMenuList className="grid grid-cols-3 items-center">
            ...
            <div className="flex justify-end">
              ...
              <Button onClick={() => setToggleForm && setToggleForm(true)}>
                Schedule Demo
              </Button>
              {/* </a> */}
            </div>
